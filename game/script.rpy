...
label fuite_fin:
	...
	# Voilà comment appeler un Shake
	# Syntax : Shake(position, duration, maximum distance) 
	#with 'position' being a tuple of 4 values : x-position, y-position, xanchor, yanchor.
